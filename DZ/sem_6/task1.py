...
# def parenthesis_expansion(line_example): # раскрытие скобок, разбитие выражения
#     new_lst = []                             #    
#     i = 0
...
#     first_lst = [i for i, j in enumerate(new_lst) if j in '*/']      # enumerate()– узнаем сразу индекс элемента и его значение    
#     while first_lst:
#         t = first_lst[0]
#         a, b, c = new_lst[t - 1: t + 2]
#         new_lst.insert(t - 1, func[b](a, c))
#         del new_lst[t: t + 3]                             # удаление переменной из списка
